...
class CandidateUsersValidationTest {
    ...
    private static final String PAYMENT_PROCESS_WITH_CANDIDATE_USERS_BPMN_URL = "/simulator/payment-process-with-candidate-users-simulation-request.json";
    ...
    void shouldReturnNoErrorWhenCandidateUsersMatch() {
        //given
        final ProcessSimulationRequest processSimulationRequest = readJson(PAYMENT_PROCESS_WITH_CANDIDATE_USERS_BPMN_URL, ProcessSimulationRequest.class);
